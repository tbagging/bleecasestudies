          ...
          <div className="bg-gradient-to-br from-purple-600 to-purple-800 rounded-lg p-6 text-white">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 text-center">
              ...
              <div className="w-24 h-24 mx-auto mb-4 rounded-full overflow-hidden">
                <img 
                  src="/lovable-uploads/23cc70d6-db9b-48d2-b4c7-18e78a04a604.png" 
                  alt="Expert profile" 
                  className="w-full h-full object-cover"
                />
              </div>
              
              <p className="mb-6">Our expert would love to hear from you by:</p>
              
              <div className="space-y-3">
                <a 
                  href="mailto:contact@blee.com" 
                  className="flex items-center justify-center gap-2 bg-white/20 hover:bg-white/30 transition-colors rounded-lg p-3"
                >
